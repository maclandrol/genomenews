...
class BaseThreadedCommentNode(BaseCommentNode):
    def __init__(self, parent=None, flat=False, root_only=False, karma=False, tree=False, **kwargs):
        self.parent = parent
        self.flat = flat
    ...
    def get_query_set(self, context):
        ...
        if self.parent:
            ...
            if(self.tree):
                temp_qs = qs.filter(pk=parent_id).first()
                tree_path =temp_qs.tree_path
...
def get_comment_list(parser, token):
    ...
    Syntax::
        ...
        {% get_comment_list for [object] as [varname] [flat|root_only|karma|tree] %}
        {% get_comment_list for [app].[model] [object_id] as [varname] %}
        {% get_comment_list for [app].[model] [object_id] as [varname] [flat|root_only|karma|tree] %}
...
def render_comment_list(parser, token):
    ...
    Syntax::
        ...
        {% render_comment_list for [object] [flat|root_only|karma|tree] %}
        {% render_comment_list for [app].[model] [object_id] [flat|root_only|karma|tree] %}
